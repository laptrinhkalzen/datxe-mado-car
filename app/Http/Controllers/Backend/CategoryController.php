...
class CategoryController extends Controller {
    ...
    public function index($type) {
        ...
        $types = array(\App\Category::TYPE_VIDEO => 'Danh mục video', \App\Category::TYPE_NEWS => 'Danh mục tin tức', \App\Category::TYPE_GALLERY => 'Danh mục hình ảnh', \App\Category::TYPE_CAR => 'Danh mục sản phẩm', \App\Category::TYPE_CONSTRUCTION => 'Danh mục thi công');
