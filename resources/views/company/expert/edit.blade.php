...
<div class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{!!route('admin.expert.update', $record->id)!!}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-6">
                                     ...
                                     <div class="col-md-6">
                                           <label class="required">Chọn quốc gia</label>
                                            <select class="select-search form-control" name="country" data-placeholder="Chọn quốc gia" required="">
                                                {!!$country_html!!}
                                            </select>
